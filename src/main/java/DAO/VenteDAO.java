...
//    }
    ...
    public boolean addFacture(Facture facture) throws SQLException{
        String ajouterVente = "INSERT INTO facture (pdf_file) VALUES (?)";
        try(PreparedStatement stmt = conn.prepareStatement(ajouterVente)) {
    ...
    public ObservableList<Vente> getAllPanier() throws SQLException{
        ...
        String getNonVendu = "SELECT v.id_medicament, m.dci, m.pu_vente, v.qte_demande, v.montant FROM medicament m JOIN vente v ON m.id_medicament = v.id_medicament WHERE v.statut_panier = true";
    ...
    public boolean validerVentePanier(int idDci) throws SQLException{
        String newCurrentStock = "UPDATE vente SET statut_panier = ? WHERE id_medicament = ?";
        try(PreparedStatement stmt = conn.prepareStatement(newCurrentStock)) {
    ...
    public boolean validerVente(int idDci) throws SQLException{
        String newCurrentStock = "UPDATE vente SET statut_paiement = ? WHERE id_medicament = ?";
        try(PreparedStatement stmt = conn.prepareStatement(newCurrentStock)) {
